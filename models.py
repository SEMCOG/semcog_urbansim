...
def diagnostic(parcels,buildings,jobs,households,nodes):
...
def elcm_simulate(jobs, buildings, nodes):
    ...
    def register_broadcast_simulate_segment(jobs_df_name, jobs_df, buildings_df_name, buildings_df, yaml_name):
        sim.add_table(jobs_df_name,jobs_df)
        sim.add_table(buildings_df_name,buildings_df)
        sim.broadcast('nodes', buildings_df_name, cast_index=True, onto_on='_node_id')
        sim.broadcast('parcels', buildings_df_name, cast_index=True, onto_on='parcel_id')
        sim.broadcast(buildings_df_name, jobs_df_name, cast_index=True, onto_on='building_id')
        jobs_df = sim.get_table(jobs_df_name)
        buildings_df = sim.get_table(buildings_df_name)
...
@sim.model('government_jobs_scaling_model')
...
@sim.model('refiner')
def refiner(jobs, households, buildings, year):
    jobs = jobs.to_frame()
    households = households.to_frame()
...
def scheduled_development_events(buildings, year):
    ...
    sched_dev[sched_dev.year_built==year]
...
def gq_model(year):
    ...
    if year==np.array([int(yr) for yr in years]).min():
        for year in years:
            print year
...
def travel_model(year, buildings, parcels, households, persons, jobs):
    if year in [2015, 2020, 2025, 2030, 2035, 2040]:
        ...
        zonal_indicators['sector1'] = jobs[jobs.sector_id==1].groupby('zone_id').size()
        zonal_indicators['sector2'] = jobs[jobs.sector_id==2].groupby('zone_id').size()
        zonal_indicators['sector3'] = jobs[jobs.sector_id==3].groupby('zone_id').size()
        zonal_indicators['sector4'] = jobs[jobs.sector_id==4].groupby('zone_id').size()
        zonal_indicators['sector5'] = jobs[jobs.sector_id==5].groupby('zone_id').size()
        zonal_indicators['sector6'] = jobs[jobs.sector_id==6].groupby('zone_id').size()
        zonal_indicators['sector7'] = jobs[jobs.sector_id==7].groupby('zone_id').size()
        zonal_indicators['sector8'] = jobs[jobs.sector_id==8].groupby('zone_id').size()
        zonal_indicators['sector9'] = jobs[jobs.sector_id==9].groupby('zone_id').size()
        zonal_indicators['sector10'] = jobs[jobs.sector_id==10].groupby('zone_id').size()
        zonal_indicators['sector11'] = jobs[jobs.sector_id==11].groupby('zone_id').size()
        zonal_indicators['sector12'] = jobs[jobs.sector_id==12].groupby('zone_id').size()
        zonal_indicators['sector13'] = jobs[jobs.sector_id==13].groupby('zone_id').size()
        ...
        zonal_indicators['sector16'] = jobs[jobs.sector_id==16].groupby('zone_id').size()
        zonal_indicators['sector17'] = jobs[jobs.sector_id==17].groupby('zone_id').size()
        ...
        zonal_indicators['sector20'] = jobs[jobs.sector_id==20].groupby('zone_id').size()
        ...
        zonal_indicators['piq11'] = hh[(hh.persons==1)*(hh.quartile==1)].groupby('zone_id').size()
        zonal_indicators['piq12'] = hh[(hh.persons==1)*(hh.quartile==2)].groupby('zone_id').size()
        zonal_indicators['piq13'] = hh[(hh.persons==1)*(hh.quartile==3)].groupby('zone_id').size()
        zonal_indicators['piq14'] = hh[(hh.persons==1)*(hh.quartile==4)].groupby('zone_id').size()
        zonal_indicators['piq21'] = hh[(hh.persons==2)*(hh.quartile==1)].groupby('zone_id').size()
        zonal_indicators['piq22'] = hh[(hh.persons==2)*(hh.quartile==2)].groupby('zone_id').size()
        zonal_indicators['piq23'] = hh[(hh.persons==2)*(hh.quartile==3)].groupby('zone_id').size()
        zonal_indicators['piq24'] = hh[(hh.persons==2)*(hh.quartile==4)].groupby('zone_id').size()
        zonal_indicators['piq31'] = hh[(hh.persons==3)*(hh.quartile==1)].groupby('zone_id').size()
        zonal_indicators['piq32'] = hh[(hh.persons==3)*(hh.quartile==2)].groupby('zone_id').size()
        zonal_indicators['piq33'] = hh[(hh.persons==3)*(hh.quartile==3)].groupby('zone_id').size()
        zonal_indicators['piq34'] = hh[(hh.persons==3)*(hh.quartile==4)].groupby('zone_id').size()
        zonal_indicators['piq41'] = hh[(hh.persons==4)*(hh.quartile==1)].groupby('zone_id').size()
        zonal_indicators['piq42'] = hh[(hh.persons==4)*(hh.quartile==2)].groupby('zone_id').size()
        zonal_indicators['piq43'] = hh[(hh.persons==4)*(hh.quartile==3)].groupby('zone_id').size()
        zonal_indicators['piq44'] = hh[(hh.persons==4)*(hh.quartile==4)].groupby('zone_id').size()
        zonal_indicators['piq51'] = hh[(hh.persons==5)*(hh.quartile==1)].groupby('zone_id').size()
        zonal_indicators['piq52'] = hh[(hh.persons==5)*(hh.quartile==2)].groupby('zone_id').size()
        zonal_indicators['piq53'] = hh[(hh.persons==5)*(hh.quartile==3)].groupby('zone_id').size()
        zonal_indicators['piq54'] = hh[(hh.persons==5)*(hh.quartile==4)].groupby('zone_id').size()

        zonal_indicators['wkau10'] = hh[(hh.workers==1)*(hh.cars==0)].groupby('zone_id').size()
        zonal_indicators['wkau10'] = hh[(hh.workers==1)*(hh.cars==1)].groupby('zone_id').size()
        zonal_indicators['wkau10'] = hh[(hh.workers==1)*(hh.cars==2)].groupby('zone_id').size()
        zonal_indicators['wkau10'] = hh[(hh.workers==1)*(hh.cars>=3)].groupby('zone_id').size()
        zonal_indicators['wkau10'] = hh[(hh.workers==2)*(hh.cars==0)].groupby('zone_id').size()
        zonal_indicators['wkau10'] = hh[(hh.workers==2)*(hh.cars==1)].groupby('zone_id').size()
        zonal_indicators['wkau10'] = hh[(hh.workers==2)*(hh.cars==2)].groupby('zone_id').size()
        zonal_indicators['wkau10'] = hh[(hh.workers==2)*(hh.cars>=3)].groupby('zone_id').size()
        zonal_indicators['wkau10'] = hh[(hh.workers>=3)*(hh.cars==0)].groupby('zone_id').size()
        zonal_indicators['wkau10'] = hh[(hh.workers>=3)*(hh.cars==1)].groupby('zone_id').size()
        zonal_indicators['wkau10'] = hh[(hh.workers>=3)*(hh.cars==2)].groupby('zone_id').size()
        zonal_indicators['wkau10'] = hh[(hh.workers>=3)*(hh.cars>=3)].groupby('zone_id').size()
        ...
        zonal_indicators['inc1w3'] = hh[(hh.quartile==1)*(hh.workers>=3)].groupby('zone_id').size()
        ...
        zonal_indicators['inc2w3'] = hh[(hh.quartile==2)*(hh.workers>=3)].groupby('zone_id').size()
        ...
        zonal_indicators['inc3w3'] = hh[(hh.quartile==3)*(hh.workers>=3)].groupby('zone_id').size()
        ...
        zonal_indicators['inc4w3'] = hh[(hh.quartile==4)*(hh.workers>=3)].groupby('zone_id').size()
        ...
        if os.path.exists('gq/tazcounts%s.csv'%year):
            ...
            zonal_indicators['TotalPop'] = zonal_indicators['GrPop'] + zonal_indicators['hhPop']
        ...
        ##########################################
        ## Uncomment if you have Transcad installed
        ##########################################
        ...
        ####Run TM
        # run_transcad_macro.run(input_dir, year)
        
        ####Import data from TM
        # run_transcad_macro.get_travel_data_from_travel_model(output_dir, year, output_file)
