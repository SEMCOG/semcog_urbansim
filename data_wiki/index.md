...
| [Development & Context](domains/development-context.md) | `events_addition`, `events_deletion`, `refiner_events`, `demolition_rates`, `landmark_worksites`, `schools`, `crime_rates`, building construction costs | PostgreSQL (event/demo tables), CSV, RS Means |
