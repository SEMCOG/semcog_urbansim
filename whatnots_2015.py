...
def main():
    out_dir = "/home/da/semcog_urbansim/runs/whatnots_2015"
    ...
    hdf15 = pd.HDFStore('/mnt/hgfs/urbansim/RDF2045/data/base_year/all_semcog_data_02-02-18-final-forecast.h5', 'r')
    from indicators.model_output_shorten import parcels, buildings, households, persons
    orca.add_table('buildings', buildings(hdf15))
    orca.add_table('parcels', parcels(hdf15, orca.get_table('zoning')))
    hh = pd.read_csv("/mnt/hgfs/urbansim/RDF2050/population_synthesis/historical/2015(2017)/092324_run_2015/households_after_refinement.csv", index_col=0)
    p = pd.read_csv("/mnt/hgfs/urbansim/RDF2050/population_synthesis/historical/2015(2017)/092324_run_2015/persons_after_refinement.csv", index_col=0)
    import variables
    ...
    # orca_year_dataset(store_la, tbls_to_load, year, year == 2020)
    for tab in geom:
