...
pf_dict['parking_cost_d'] = {ptype: pf_dict['parking_cost_d'][ptype] * 0.9 for ptype in
                             pf_dict['parking_cost_d']}

pf_dict['uses'] = ['retail', 'industrial', 'office', 'medical', 'residential']
pf_dict['residential_uses'] = [False, False, False, False, True]
pf_dict['forms'] = {
    'retail': {
        "retail": 1.0
    },
...
pf_dict['building_efficiency'] = .85
pf_dict['parcel_coverage'] = .85

pf_dict['costs'] = {
    "residential": [106.0, 96.0, 160.0, 180.0, 180.0, 205.0, 205.0, 205.0,
                    999.0],
    "industrial": [125.0, 125.0, 130.0, 999.0, 999.0, 999.0, 999.0, 999.0,
                   999.0],
...
pf_dict['construction_months']['medical'] = (
    pf_dict['construction_months']['office'])
